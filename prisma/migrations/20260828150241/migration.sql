/*
  ...
  - A unique constraint covering the columns `[joiningTime,scheduleId,serialNumber]` on the table `appointments` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "appointments_joiningTime_scheduleId_serialNumber_key" ON "appointments"("joiningTime", "scheduleId", "serialNumber");
